...
print("because weapon is the property of Fighter class and falcon was the instance of the parent class which is Spaceship which does not have weapon property")
