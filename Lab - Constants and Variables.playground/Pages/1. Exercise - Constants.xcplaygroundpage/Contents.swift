...
print("because let is used for constants,values that are immutable means cannot be changed so we cannot the change the friends value bec it is defined with let means constant")
