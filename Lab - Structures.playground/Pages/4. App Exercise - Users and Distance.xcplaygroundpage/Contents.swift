...
var sagar = User(name: "Sagar", age: 23, height: 180, weight: 68, activityLevel: 7)
print("\(sagar.name) is \(sagar.age) years old. He is \(sagar.height)cm tall and weighs \(sagar.weight)kg. His activity level is \(sagar.activityLevel).")
