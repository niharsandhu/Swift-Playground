 ...
 */
var list1: [String] = ["walk 10,000 steps a day in a week","take a 30 mints walk every morning "]
var list2: [String] = ["run 5 km daily","run 3 times a day"]
