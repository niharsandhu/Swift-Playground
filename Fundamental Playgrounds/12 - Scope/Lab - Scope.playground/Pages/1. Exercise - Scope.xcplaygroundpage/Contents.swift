...
print("Because the foo variable will be out of the scope outside of the for loop")
...
print("Compiled because the scope has been increased to global by defining the variable outside of the for loop")
