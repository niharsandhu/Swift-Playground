...
print(calculateArea(x: 15, y: 10) ?? "Nil Value")
print(calculateArea(x: -5, y: -1) ?? "Nil Value")
...
print(add(a: 10, b: 20) ?? "Nil Value")
print(add(a: nil, b: 20) ?? "Nil Value")
print(add(a: 10, b: nil) ?? "Nil Value")
print(add(a: nil, b: nil) ?? "Nil Value")
/*:
...
print(createUser()?.firstName ?? "No user")
print(createUser()?.lastName ?? "No user")
print(createUser()?.age ?? "No user")
/*:
